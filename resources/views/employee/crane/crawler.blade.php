            ...
            <form style="height: 600px; width: 1350px; overflow-y: auto; margin: unset">
                ...
                <div style="margin: 10px 20px 10px 20px; box-shadow: 0 0 20px rgba(15,70,108,0.65); width: 1270px">
                    <div style="padding: 10px; background-color: rgba(240,248,248,0.05)">
                        ...
                        <input type="radio" name="th" id="th1" style="margin-left: 20px" value="Yes"><label for="th1" style="color: #0b3756; font-size: 17px; margin-left: 5px">Yes</label>
                        <input type="radio" name="th" id="th2" style="margin-left: 20px" value="No"><label for="th2" style="color: #0b3756; font-size: 17px; margin-left: 5px">No</label>
                    </div>
                </div>
