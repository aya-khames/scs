        ...
        <fieldset>
            ...
            <form style="margin: 20px; box-shadow: 0 0 20px rgba(15,70,108,0.65); width: 1250px">
                <div style="padding: 20px; border-radius: 5px; background-color: rgba(240,248,248,0.05)">
                    <label class="lab" style="font-size: 20px; width: 130px">Quotation:</label> <input class="text2" style="width: 400px" type="text">
                        <span>
                    ...
                    <br>
                    <span>
                        <textarea readonly class="text2" style="width: 400px; height: 50px; margin-left: 150px; scroll-behavior: smooth; display: inline-block; resize: none">Maximum ONE MONTH from invoice date.</textarea>
                    </span>
                </div>
            </form>
