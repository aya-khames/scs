            ...
            <div style="margin: 5px; height: 600px; overflow-y: auto; width: 1340px">
                    ...
                    <div style="padding: 20px; border-radius: 5px; background-color: rgba(240,248,248,0.05)">
                        ...
                        <a style="padding: unset">
                            ...
                            {{--  @foreach($clients as $client)
                                    <option value="{{$client->name}}">{{$client->Name_C}}</option>
                                @endforeach
                                --}}
                            </select>
                        </a>
                ...
                <form style="margin: 10px 20px 10px 20px;box-shadow: 0 0 20px rgba(15,70,108,0.65); width: 1270px">
                    <div style="padding: 20px; background-color: rgba(240,248,248,0.05)">
                        ...
                        <input type="radio" style="margin-left: 20px"><label style="color: #0b3756; font-size: 17px; margin-left: 5px">Test Examination</label>
                        <input type="radio" style="margin-left: 20px"><label style="color: #0b3756; font-size: 17px; margin-left: 5px">Visual</label>
                ...
                <label style="margin: 20px 20px 5px 40px; color: #0b3756; font-family: 'Times New Roman'; font-size: 25px; font-style: italic; font-weight: bold">UNIT</label>
                <form style="margin: 0 20px 10px 20px;box-shadow: 0 0 20px rgba(15,70,108,0.65); width: 1270px">
                    <div style="padding: 20px; background-color: rgba(240,248,248,0.05)">
