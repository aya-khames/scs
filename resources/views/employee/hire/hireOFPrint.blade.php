            ...
            <div style="height: 640px; width: 1290px; overflow-y: auto">
                <form style="margin: 20px; box-shadow: 0 0 20px rgba(15,70,108,0.65); width: 1250px">
                    <div style="padding: 20px; border-radius: 5px; background-color: rgba(240,248,248,0.05)">
                        ...
                        <input class="text2" style="width: 400px" type="text"> <a class="sp" style="margin-left: 10px; margin-right: 10px;cursor: pointer" onclick="showTable('table')">Search</a>
                        <label class="lab" style="font-size: 20px; width: 80px">Hire Off:</label>
                        <input class="text2" style="width: 400px" type="text"> <a class="sp" style="margin-left: 10px;cursor: pointer" onclick="showTable('table')">Search</a><br>
                        <br>
