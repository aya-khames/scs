        ...
        <fieldset>
            ...
            <form style="margin: 20px; box-shadow: 0 0 20px rgba(15,70,108,0.65); width: 1250px">
                <div style="padding: 20px; border-radius: 5px; background-color: rgba(240,248,248,0.05)">
                    ...
                    <label class="lab" style="font-size: 20px; width: 170px">Certificate No:</label> <input class="text2" style="width: 400px" type="text">
                    ...
                    <input class="Date text2" style="width: 190px" type="date">
                    <input class="Date text2" style="width: 195px; display: inline-block" type="text">
