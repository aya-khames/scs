                    ...
                    <div style="margin: 20px; box-shadow: 0 0 20px rgba(15,70,108,0.65); width: 1270px">
                        <div style="padding: 20px; border-radius: 5px; background-color: rgba(240,248,248,0.05)">
                            ...
                            <a style="padding: unset">
                                <select id="clientname" name="cient" class="miniDrop2" id="client" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
{{--                                    <option>11</option>--}}
                            ...
                            <input id="certNo" name="certNo" disabled readonly id="certNo" class="text2" style="width: 400px" type="text">
